...
const Page = () => {
  ...
  return (
    <div className="mx-auto page-transition">
      ...
      {/* Developer Section */}
      <div className="mb-6">
        <h2 className="text-xl font-semibold mb-3">Разработчикам</h2>
        <div className="space-y-3">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium">API для разработчиков</p>
                <p className="text-sm text-muted-foreground">Создавайте интеграции с SAMGA API</p>
              </div>
            </div>
